 ...
 * Created by ( Eng Ali)
 */
class ContactsWhatsAppActivityAdabter(val contactsList:ArrayList<Contacts>, var contactsActivity: ContactsWhatsAppActivity):RecyclerView.Adapter<ContactsWhatsAppActivityAdabter.ViewHolder>() {
