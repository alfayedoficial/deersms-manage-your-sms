...
import com.alialfayed.deersms.view.adabter.ContactsWhatsAppActivityAdabter
import kotlinx.android.synthetic.main.activity_contacts_sms.*


class ContactsWhatsAppActivity : AppCompatActivity() {
...
//        )
        ...
        cursor.close()
        val adapter = ContactsWhatsAppActivityAdabter(contactsList, this)
